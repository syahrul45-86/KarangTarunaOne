...
<div class="container-fluid mt-4 mb-5" style="max-width: 600px;">
    ...
    <div class="bendahara-form-wrapper">
        <div class="bendahara-form-header">
            <h3><i class="fas fa-wallet mr-2"></i> Tambah Saldo Awal</h3>
            <p>Masukkan saldo kas awal untuk RT Anda sebelum mencatat transaksi.</p>
        </div>
        ...
        <div class="bendahara-form-body">
            <form action="{{ route('bendahara.storeSaldoAwal') }}" method="POST">
                ...
                <div class="bendahara-form-group">
                    <label class="bendahara-form-label">Total Saldo Awal <span class="text-danger">*</span></label>
                    <div class="input-group bendahara-input-group">
                        ...
                        <input type="number" name="saldo_awal" 
                               ...
                               placeholder="Contoh: 500000" min="0" value="{{ old('saldo_awal') }}" required>
                    </div>
                    @error('saldo_awal')
