...
<div class="denda-page-wrapper">
    <!-- Header Section -->
    <div class="denda-header-section">
        <div class="denda-header-content">
            <h3>Daftar Denda</h3>
            <a href="{{ route('bendahara.denda.create') }}" class="denda-btn-add">
                Tambah Denda Manual
            </a>
        </div>
    </div>
        ...
        <table class="denda-table-desktop" id="dendaTable">
            ...
            <tbody>
                ...
                <tr style="animation-delay: {{ $loop->iteration * 0.05 }}s">
                    ...
                    <td>
                        @if($row->jenis == 'absensi')
                            <span class="denda-badge denda-badge-absensi">Absensi</span>
                        @else
                            <span class="denda-badge denda-badge-manual">Manual</span>
                        @endif
                    </td>
        ...
        <div class="denda-mobile-cards" id="dendaMobileCards">
            ...
            <div class="denda-mobile-card"
                ...
                <div class="denda-info-item">
                    <div class="denda-info-label">Jenis</div>
