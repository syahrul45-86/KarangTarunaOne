...
<div class="sekretaris-dashboard-wrapper">
    ...
    <div class="sekretaris-stats-row">
        ...
        <div class="sekretaris-stat-card sekretaris-card-warning">
            <div class="sekretaris-stat-header">
                <div class="sekretaris-stat-content">
                    <div class="sekretaris-stat-label">🎯 Denda Kegiatan (Belum Bayar)</div>
                    <div class="sekretaris-stat-value" style="font-size: 22px;">Rp {{ number_format($dendaBelumBayarPribadi, 0, ',', '.') }}</div>
                    <div class="sekretaris-stat-subtitle">Total denda kegiatan Anda</div>
                </div>
                <div class="sekretaris-stat-icon" style="background: #fffbeb; color: #f59e0b;">
        ...
        <div class="sekretaris-stat-card sekretaris-card-cyan">
            <div class="sekretaris-stat-header">
                <div class="sekretaris-stat-content">
                    <div class="sekretaris-stat-label">💰 Tunggakan Arisan</div>
                    <div class="sekretaris-stat-value" style="font-size: 22px;">Rp {{ number_format($tunggakanArisanPribadi, 0, ',', '.') }}</div>
                    <div class="sekretaris-stat-subtitle">Total tunggakan arisan Anda</div>
                </div>
                <div class="sekretaris-stat-icon" style="background: #cffafe; color: #0891b2;">
        ...
        <!-- Denda Keseluruhan -->
        <div class="sekretaris-stat-card sekretaris-card-danger">
            <div class="sekretaris-stat-header">
                <div class="sekretaris-stat-content">
                    <div class="sekretaris-stat-label">🚨 Denda Keseluruhan</div>
                    <div class="sekretaris-stat-value" style="font-size: 22px;">Rp {{ number_format($totalDendaKeseluruhanPribadi, 0, ',', '.') }}</div>
                    <div class="sekretaris-stat-subtitle">Total Denda Kegiatan + Arisan Anda</div>
                </div>
                <div class="sekretaris-stat-icon" style="background: #fee2e2; color: #dc2626;">
