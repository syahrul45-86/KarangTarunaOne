...
<style>
    ...
    .tb-card-header { background: #f8fafc; border-bottom: 1px solid #f1f5f9; padding: 18px 28px; display: flex; align-items: center; gap: 12px; }
    .tb-card-header-icon { width: 38px; height: 38px; border-radius: 11px; background: #2563eb; display: flex; align-items: center; justify-content: center; color: #fff; font-size: 0.95rem; flex-shrink: 0; }
    ...
    .tb-label i { color: #2563eb; font-size: 0.8rem; }
    ...
    .tb-control:focus { border-color: #2563eb !important; background: #fff !important; box-shadow: 0 0 0 4px rgba(37,99,235,0.1) !important; outline: none !important; }
    .tb-control.is-invalid { border-color: #ef4444 !important; background: #fef2f2 !important; }

    .tb-field-wrap { position: relative; }
    .tb-icon-prefix { position: absolute; left: 14px; top: 50%; transform: translateY(-50%); color: #2563eb; font-size: 0.85rem; pointer-events: none; }
    .tb-text-prefix { position: absolute; left: 14px; top: 50%; transform: translateY(-50%); color: #2563eb; font-size: 0.88rem; font-weight: 700; pointer-events: none; }
    ...
    .tb-radio-card input { margin: 0; width: 18px; height: 18px; accent-color: #2563eb; cursor: pointer; }
    ...
    .btn-tb-reset { background: #f1f5f9; color: #64748b; border: none; border-radius: 12px; padding: 12px 24px; font-weight: 600; font-size: 0.88rem; transition: all 0.2s ease; display: inline-flex; align-items: center; gap: 6px; }
    .btn-tb-reset:hover { background: #e2e8f0; color: #334155; }
    .btn-tb-submit { background: linear-gradient(135deg, #0ea5e9, #2563eb); color: #fff; border: none; border-radius: 12px; padding: 12px 32px; font-weight: 700; font-size: 0.88rem; box-shadow: 0 6px 20px rgba(37,99,235,0.3); transition: all 0.3s ease; display: inline-flex; align-items: center; gap: 7px; }
    .btn-tb-submit:hover { transform: translateY(-2px); box-shadow: 0 10px 25px rgba(37,99,235,0.4); color: #fff; }
...
<div class="tb-form-page px-2">
    ...
    <div class="tb-form-header">
        <div class="d-flex align-items-center" style="min-width:0;">
            <div class="tb-form-icon"><i class="fas fa-plus-circle"></i></div>
            <div style="min-width:0;">
                <h1 class="tb-form-title">Tambah Transaksi Tabungan</h1>
                <p class="tb-form-sub">Catat uang masuk (setoran) atau keluar (penarikan)</p>
            </div>
        </div>
        ...
        <div class="col-12 col-lg-9 col-xl-8">
            <div class="card tb-card">
                <div class="tb-card-header">
                    <div class="tb-card-header-icon"><i class="fas fa-file-invoice"></i></div>
                    <div>
                        <p class="tb-card-header-title">Form Input Transaksi</p>
                        <p class="tb-card-header-sub">Isi form di bawah dengan benar</p>
                    </div>
                </div>
                ...
                <div class="tb-card-body">
                    <form action="{{ route('bendahara.tabungan.store') }}" method="POST">
                        ...
                        <div class="tb-group">
                            ...
                            <div class="tb-radio-group">
                                <label class="tb-radio-card setoran">
                                    <input type="radio" name="jenis_transaksi" value="setoran" {{ old('jenis_transaksi', 'setoran') == 'setoran' ? 'checked' : '' }} required>
                                    <div class="r-icon"><i class="fas fa-arrow-down"></i></div>
                                    <div class="r-text">Setoran (Menabung)</div>
                                </label>
                                <label class="tb-radio-card penarikan">
                                    <input type="radio" name="jenis_transaksi" value="penarikan" {{ old('jenis_transaksi') == 'penarikan' ? 'checked' : '' }} required>
                            ...
                            <div class="col-12 col-md-6">
                                <div class="tb-group">
                                    ...
                                    <div class="tb-field-wrap">
                                        ...
                                        <input type="number" name="nominal" class="tb-control w-prefix @error('nominal') is-invalid @enderror" placeholder="Contoh: 50000" value="{{ old('nominal') }}" min="100" required>
                                    </div>
                            ...
                            <div class="col-12 col-md-6">
                                <div class="tb-group">
                                    ...
                                    <div class="tb-field-wrap">
                                        ...
                                        <input type="date" name="tanggal" class="tb-control w-icon @error('tanggal') is-invalid @enderror" value="{{ old('tanggal', date('Y-m-d')) }}" required>
                                    </div>
                        ...
                        <div class="tb-group">
                            ...
                            <textarea name="keterangan" class="tb-control @error('keterangan') is-invalid @enderror" placeholder="Contoh: Tabungan bulan Agustus..." rows="3">{{ old('keterangan') }}</textarea>
                        ...
                        <div class="tb-btns">
                            <button type="reset" class="btn-tb-reset"><i class="fas fa-undo"></i> Reset</button>
                            <button type="submit" class="btn-tb-submit"><i class="fas fa-save"></i> Simpan Transaksi</button>
                        </div>
                    </form>
                </div>
            </div>
